...
! For plant
!integer,parameter :: PFT  = 12   !不包含40，41
   integer,parameter :: PFT  = 15   !15th means others types
   !(/1,2,6,9,10,13,14,15,40,41,1001,1002,1003,1004/) =>(/conifer evergreen,conifer decidous,broadleaf decidous,broadleaf evergreen,mix,shrub,grass,crop,c4grass,c4crop/)
