...
PROGRAM orchideeoasis
  ...
  INTEGER, ALLOCATABLE, DIMENSION(:,:) :: maskinv_glo
  ...
  REAL    :: date0, date0_shifted, dt, julian, julian0
  ...
  !- output fields
  !-
  REAL, ALLOCATABLE, DIMENSION (:)            :: z0            !! Surface roughness
  ...
  INTEGER :: loc_size, glo_size ! number of pes used
  INTEGER :: loc_rank, glo_rank ! rank of current pe 
  INTEGER :: localComm, LOCAL_OASIS_COMM  ! local MPI communicator and Initialized
  INTEGER :: comp_id    ! component identification
  INTEGER :: ierror, flag, oasis_info
