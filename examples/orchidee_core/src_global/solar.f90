...
!!
!! SVN          :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE-CN-P/ORCHIDEE/src_global/solar.f90 $
...
!_ ================================================================================================================================
  ...
  SUBROUTINE solarang (julian, julian0, iim, jjm, lon, lat, csang)
    ...
    USE calendar
    USE time, ONLY : one_year, calendar_str
...
!_ ================================================================================================================================
    ...
    IF (printlev >= 4) WRITE(numout,*) 'Calendar information', julian, julian0
    !-
    !- 1) Day angle gamma
    !-
    ...
    !-    in radians
    !-
    IF (printlev >= 4) WRITE(numout,*) 'Solar declination', gamma, one_year
    !
    ...
    !-
    IF (printlev >= 4) WRITE(numout,*) 'Equation of time', decd
    ...
    !-
    !igmt = NINT(gmt)
    IF (printlev >= 4) WRITE(numout,*) 'Get time zone', et, gmt
    CALL time_zone(gmt, iim, jjm, lon, zone, lhour)
    !-
    !- Start a loop through the grid
    !-
    IF (printlev >= 4) WRITE(numout,*) 'Start a loop through the grid'
    DO ilon=1,iim
       !---
...
!_ ================================================================================================================================
  ...
  SUBROUTINE downward_solar_flux (npoi,latitude,jday,rtime,cloud,nband,solad,solai)
...
!_ ================================================================================================================================
    ...
    IF (lstep_init) THEN
       ...
       IF (printlev >= 1) WRITE(numout,*) 'ECCENTRICITY: ',ecc
       !
       ...
       IF (printlev >= 1) WRITE(numout,*) 'PERIHELIE: ',perh
       !
       ...
       IF (printlev >= 1) WRITE(numout,*) 'OBLIQUITY: ',xob
