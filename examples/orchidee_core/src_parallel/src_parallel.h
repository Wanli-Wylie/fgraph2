...
!
!>\BRIEF       Redefinition of MPI functions if not second underscore in MPI library.
!!
...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE-CN-P/ORCHIDEE/src_parallel/src_parallel.h $
