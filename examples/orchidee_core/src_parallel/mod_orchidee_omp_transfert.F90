...
!
!>\BRIEF     Low level OpenMP parallel communication encapsulations for ORCHIDEE.
!!
...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE-CN-P/ORCHIDEE/src_parallel/mod_orchidee_omp_transfert.F90 $
...
MODULE mod_orchidee_omp_transfert
  ...
  INTEGER,SAVE,ALLOCATABLE,DIMENSION(:) :: omp_ibuffer
  INTEGER,SAVE                            :: size_i=0
  LOGICAL,SAVE,ALLOCATABLE,DIMENSION(:) :: omp_lbuffer
  INTEGER,SAVE                            :: size_l=0
  REAL,SAVE,ALLOCATABLE,DIMENSION(:) :: omp_rbuffer
  ...
  !! INTERFACE   :  bcast_omp
  !!
  !>\BRIEF         Send a variable from master thread to all threads OMP  
  !!
  !! DESCRIPTION  : NONE
  !!
  !! \n
  ...
  !!
  !>\BRIEF        Distribute a  field on the process MPI grid from the master thread to the local domain on each threads omp
  !!
  !! DESCRIPTION  :   NONE
  !!
  !! \n
  ...
  !!
  !>\BRIEF          Each thread OMP  send their local field to the master thread which will recieve 
  !!                the field on the MPI domain 
  !!
  !! DESCRIPTION  : NONE
  !!
  !! \n
  !_ ================================================================================================================================
  INTERFACE gather_omp
     MODULE PROCEDURE gather_omp_i0,gather_omp_i,gather_omp_i1,gather_omp_i2,gather_omp_i3,gather_omp_i4,gather_omp_i5, &
          gather_omp_r0,gather_omp_r,gather_omp_r1,gather_omp_r2,gather_omp_r3,gather_omp_r4,gather_omp_r5, &
          gather_omp_l0,gather_omp_l,gather_omp_l1,gather_omp_l2,gather_omp_l3,gather_omp_l4,gather_omp_l5
  END INTERFACE
  ...
  !!
  !>\BRIEF       The master thread will recieve the sum of the values from all threads 
  !!
  !! DESCRIPTION  : NONE
  !!
  !! \n
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  SUBROUTINE bcast_omp_c(Var)
    ...
    CHARACTER(LEN=80),DIMENSION(1) :: Var1
...
!!!!! --> Les entiers
  ...
  SUBROUTINE gather_omp_i4(VarIn, VarOut)
...
#else
    CALL check_buffer_i(size(VarOut))   
    CALL orch_gather_omp_igen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4)*SIZE(VarIn,5),omp_ibuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_omp_i4

  SUBROUTINE gather_omp_i5(VarIn, VarOut)
...
#else
    CALL check_buffer_i(size(VarOut))   
    CALL orch_gather_omp_igen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4)*SIZE(VarIn,5)*SIZE(VarIn,6),omp_ibuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_omp_i5
...
!!!!! --> Les reels
  ...
  SUBROUTINE gather_omp_r4(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarOut))   
    CALL orch_gather_omp_rgen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4)*SIZE(VarIn,5),omp_rbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_omp_r4


  SUBROUTINE gather_omp_r5(VarIn, VarOut)
...
#else
    CALL check_buffer_r(size(VarOut))   
    CALL orch_gather_omp_rgen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4)*SIZE(VarIn,5)*SIZE(VarIn,6),omp_rbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_omp_r5
...
!!!!! --> Les booleen
  ...
  SUBROUTINE gather_omp_l4(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarOut))   
    CALL orch_gather_omp_lgen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4)*SIZE(VarIn,5),omp_lbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_omp_l4


  SUBROUTINE gather_omp_l5(VarIn, VarOut)
...
#else
    CALL check_buffer_l(size(VarOut))   
    CALL orch_gather_omp_lgen(VarIn,Varout,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4)*SIZE(VarIn,5)*SIZE(VarIn,6),omp_lbuffer)
#endif    
    IF ( check_all_transfert ) &
        omp_function(omp_rank)=omp_previous
  END SUBROUTINE gather_omp_l5
