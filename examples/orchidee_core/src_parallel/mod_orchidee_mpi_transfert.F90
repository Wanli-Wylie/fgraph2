...
!!
!! SVN              :
!! $HeadURL: svn://forge.ipsl.jussieu.fr/orchidee/branches/ORCHIDEE-CN-P/ORCHIDEE/src_parallel/mod_orchidee_mpi_transfert.F90 $
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  SUBROUTINE scatter_mpi_i(VarIn, VarOut)
    ...
    INTEGER,INTENT(OUT),DIMENSION(nbp_mpi) :: VarOut
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarOut,2)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarOut,2)*SIZE(VarOut,3)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarOut,2)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarOut,2)*SIZE(VarOut,3)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarOut,2)*SIZE(VarOut,3)*SIZE(VarOut,4)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarIn,2)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarIn,2)*SIZE(VarIn,3)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarIn,2)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarIn,2)*SIZE(VarIn,3)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarIn,2)*SIZE(VarIn,3)*SIZE(VarIn,4)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarOut,3)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarOut,3)*SIZE(VarOut,4)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarOut,3)*SIZE(VarOut,4)*SIZE(VarOut,5)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarOut,3)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarOut,3)*SIZE(VarOut,4)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarOut,3)*SIZE(VarOut,4)*SIZE(VarOut,5)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarIn,3)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarIn,3)*SIZE(VarIn,4)) :: dummy
#endif
...
#ifdef CPP_PARA
    INTEGER,DIMENSION(1,SIZE(VarIn,3)*SIZE(VarIn,4)*SIZE(VarIn,5)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarIn,3)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarIn,3)*SIZE(VarIn,4)) :: dummy
#endif
...
#ifdef CPP_PARA
    REAL,DIMENSION(1,SIZE(VarIn,3)*SIZE(VarIn,4)*SIZE(VarIn,5)) :: dummy
#endif
...
SUBROUTINE orch_scatter_mpi_igen(VarIn, VarOut, nbp, dimsize)
  ...
  INTEGER,INTENT(IN),DIMENSION(nbp,dimsize) :: VarIn
...
SUBROUTINE orch_scatter_mpi_rgen(VarIn, VarOut, nbp, dimsize)
  ...
  INTEGER,INTENT(IN) :: dimsize
  INTEGER,INTENT(IN) :: nbp
  REAL,INTENT(IN),DIMENSION(nbp,dimsize) :: VarIn
...
SUBROUTINE orch_gather_mpi_igen(VarIn, VarOut, nbp, dimsize)
  ...
  INTEGER,INTENT(OUT),DIMENSION(nbp,dimsize) :: VarOut
...
SUBROUTINE orch_gather_mpi_rgen(VarIn, VarOut, nbp, dimsize)
  ...
  REAL,INTENT(OUT),DIMENSION(nbp,dimsize) :: VarOut
...
SUBROUTINE orch_scatter2D_mpi_igen(VarIn, VarOut, nbp2D, dimsize)
  ...
  INTEGER,INTENT(IN) :: dimsize
  INTEGER,INTENT(IN) :: nbp2D
  INTEGER,INTENT(IN),DIMENSION(nbp2D,dimsize) :: VarIn
...
SUBROUTINE orch_scatter2D_mpi_rgen(VarIn, VarOut, nbp2D, dimsize)
  ...
  INTEGER,INTENT(IN) :: dimsize
  INTEGER,INTENT(IN) :: nbp2D
  REAL,INTENT(IN),DIMENSION(nbp2D,dimsize) :: VarIn
  REAL,INTENT(INOUT),DIMENSION(iim*jj_nb,dimsize) :: VarOut
...
SUBROUTINE orch_gather2D_mpi_igen(VarIn, VarOut, nbp2D, dimsize)
  ...
  INTEGER,INTENT(OUT),DIMENSION(nbp2D,dimsize) :: VarOut
...
SUBROUTINE orch_gather2D_mpi_rgen(VarIn, VarOut, nbp2D,dimsize)
  ...
  REAL,INTENT(OUT),DIMENSION(nbp2D,dimsize) :: VarOut
